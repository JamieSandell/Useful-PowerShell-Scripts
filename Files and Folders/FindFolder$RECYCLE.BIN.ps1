...
$baseDir = "c:\users" #directory to search, can use wildcards, will search all subdirectories recursively
$nameToFind = '$RECYCLE.BIN' #the name of the folder to look for

$machines = Get-Content -Path '.\FindFolderMachines.txt' #read in a name of computers to search
...
$savePath = "C:\temp\"
$saveFile = '$RECYCLE.BINFoldersFound.csv'
