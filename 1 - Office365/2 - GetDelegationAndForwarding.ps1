...
$UserInboxRules | Export-Csv c:\temp\MailForwardingRulesToExternalDomains.csv
$UserDelegates | Export-Csv c:\temp\MailboxDelegatePermissions.csv
$SMTPForwarding | Export-Csv c:\temp\Mailboxsmtpforwarding.csv